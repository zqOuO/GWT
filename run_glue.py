...
from galore_torch import GaLoreAdamW, WaveAdamW
...
def parse_args():
    ...
    parser.add_argument("--enable_wave", action="store_true", help="Whether or not to use low rank optimizer.")
    # Wave parameters
...
def main():
    ...
    if not args.enable_galore and not args.enable_wave:
        optimizer = torch.optim.AdamW(optimizer_grouped_parameters, lr=args.learning_rate)

    elif args.enable_wave:
        ...
        for module_name, module in model.named_modules():
            ...
            print('enable Wavelet for weights in module: ', module_name)
        ...
        optimizer = WaveAdamW(param_groups, lr=args.learning_rate)
